...
Follow-up: recipe rows expose expandable ingredients, preparation instructions, notes and nutrients. Amounts and nutrients scale to selected portions, while prose remains the base recipe. These details use the same offline cache.
