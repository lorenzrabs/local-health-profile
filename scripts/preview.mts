...
for(let i=0;i<90;i++){
 ...
 names.forEach((_,n)=>{if(i%13!==0 && (n!==0 || (i+n)%3===0))entries.push({habitClientId:'preview-'+n,date,completed:(i+n)%3===0,updatedAt:date+'T00:00:00Z'});});
 ...
 if(i%4===0)samples.push({sourceId:'mindful'+i,type:'mindfulSession',unit:'min',value:3,startAt:date+'T08:00:00Z',endAt:date+'T08:03:00Z'});
